...
(
  ...
  'CD61', 'Parc des Virunga, Nord-Kivu', 1, 'pcode',
...
(
  ...
  'CD61', 'Mangina / Beni, Nord-Kivu', 1, 'city',
...
(
  ...
  'CD61', 'Goma et zones de déplacement, Nord-Kivu', 1, 'city',
  ST_SetSRID(ST_MakePoint(29.2333, -1.6833), 4326),
...
(
  ...
  'ocha', NULL, NULL,
  'CD91', 'Kananga, Kasaï-Central', 1, 'city',
...
(
  ...
  'ocha', NULL, NULL,
  'CD53', 'Niangara, Haut-Uélé', 1, 'city',
...
(
  ...
  'CD61', 'Nord-Kivu (épicentre national)', 1, 'pcode',
  ST_SetSRID(ST_MakePoint(29.2333, -1.6833), 4326),
...
(
  ...
  'CD62', 'Kalehe (Nyamukubi-Bushushu), Sud-Kivu', 1, 'city',
...
(
  ...
  'ocha', NULL, NULL,
  'CD62', 'Uvira et Fizi, Sud-Kivu', 1, 'city',
  ST_SetSRID(ST_MakePoint(29.1383, -3.3944), 4326),
...
(
  ...
  'CD10', 'Kinshasa (Kimbanseke, Kisenso, Masina)', 1, 'city',
...
(
  ...
  'flood', 'resolved', 'Severe', 'medium',
  'ocha', NULL, NULL,
  'CD10', 'Kinshasa (Limete, Mont-Ngafula)', 1, 'city',
  ST_SetSRID(ST_MakePoint(15.2663, -4.3219), 4326),
...
(
  ...
  'flood', 'resolved', 'Severe', 'high',
  'ocha', NULL, NULL,
  'CD74', 'Kalemie, Tanganyika', 1, 'city',
...
(
  ...
  'flood', 'resolved', 'Moderate', 'medium',
  'official', NULL, NULL,
  'CD71', 'Lubumbashi, Haut-Katanga', 1, 'city',
...
(
  ...
  'flood', 'resolved', 'Moderate', 'medium',
  'official', NULL, NULL,
  'CD20', 'Matadi, Kongo-Central', 1, 'city',
...
(
  ...
  'CD62', 'Nyamukubi, Kalehe, Sud-Kivu', 1, 'city',
  ST_SetSRID(ST_MakePoint(28.9036, -2.0964), 4326),
...
(
  ...
  'ocha', NULL, NULL,
  'CD61', 'Rutshuru, Nord-Kivu', 1, 'city',
...
(
  ...
  'CD92', 'Kasaï (Tshikapa et Grand-Kasaï)', 1, 'city',
...
(
  ...
  'CD61', 'Territoire de Beni, Nord-Kivu', 1, 'city',
  ST_SetSRID(ST_MakePoint(29.4731, 0.4920), 4326),
...
(
  ...
  'CD61', 'Rutshuru / Kiwanja, Nord-Kivu', 1, 'city',
...
(
  ...
  'ocha', NULL, NULL,
  'CD62', 'Minembwe, hauts plateaux Sud-Kivu', 1, 'city',
...
(
  ...
  'CD61', 'Est de la RDC (Nord-Kivu, Sud-Kivu, Ituri)', 1, 'pcode',
  ST_SetSRID(ST_MakePoint(29.2333, -1.6833), 4326),
...
(
  ...
  'mass_displacement', 'active', 'Extreme', 'high',
  'ocha', NULL, NULL,
  'CD61', 'Camps de Bulengo / Lushagala, Goma', 1, 'city',
  ST_SetSRID(ST_MakePoint(29.2333, -1.6833), 4326),
...
(
  ...
  'CD92', 'Grand-Kasaï (Kasaï, Kasaï-Central, Kasaï-Oriental)', 1, 'city',
  ST_SetSRID(ST_MakePoint(20.8000, -6.4167), 4326),
...
(
  ...
  'fews_net', NULL, NULL,
  'CD74', 'Tanganyika (Kalemie, Kongolo)', 1, 'city',
  ST_SetSRID(ST_MakePoint(29.1833, -5.9333), 4326),
...
(
  ...
  'drought', 'resolved', 'Moderate', 'medium',
  'fews_net', NULL, NULL,
  'CD73', 'Kamina, Haut-Lomami', 1, 'city',
...
(
  ...
  'CD10', 'République Démocratique du Congo (national)', 1, 'pcode',
...
(
  ...
  'flood', 'resolved', 'Moderate', 'medium',
  'official', NULL, NULL,
  'CD82', 'Mbuji-Mayi, Kasaï-Oriental', 1, 'city',
...
(
  ...
  'official', NULL, NULL,
  'CD10', 'Kinshasa (Kasa-Vubu)', 1, 'city',
  ST_SetSRID(ST_MakePoint(15.2663, -4.3219), 4326),
...
(
  ...
  'reliefweb', NULL, NULL,
  'CD62', 'Lac Kivu / Bukavu, Sud-Kivu', 1, 'city',
...
(
  ...
  'CD41', 'Équateur (zone frontière)', 1, 'pcode',
  ST_SetSRID(ST_MakePoint(18.2833, 0.0500), 4326),
...
(
  ...
  'flood', 'resolved', 'Moderate', 'low',
  'ocha', NULL, NULL,
  'CD74', 'Kongolo, Tanganyika', 1, 'city',
...
(
  ...
  'fire', 'resolved', 'Moderate', 'medium',
  'official', NULL, NULL,
  'CD61', 'Parc national des Virunga, Nord-Kivu', 1, 'pcode',
  ST_SetSRID(ST_MakePoint(29.2333, -1.6833), 4326),
