...
INSERT INTO disaster_events (
  ...
  (
    ...
    'official', 'CD01', 'Kinshasa — Commune de Limete', 3, 'pcode',
    ARRAY['CD01'], 12500, NOW() - INTERVAL '2 days',
  ...
  (
    ...
    'ocha', 'CD14', 'Territoire de Beni — Nord-Kivu', 2, 'territory',
    ARRAY['CD14'], 45000, NOW() - INTERVAL '5 days',
  ...
  (
    ...
    'official', 'CD12', 'Zone de santé d''Uvira — Sud-Kivu', 3, 'pcode',
    ARRAY['CD12'], 3200, NOW() - INTERVAL '7 days',
  ...
  (
    ...
    'field_agent', 'CD12', 'Territoire de Kalehe — Sud-Kivu', 2, 'pcode',
    ARRAY['CD12'], 800, NOW() - INTERVAL '1 day',
  ...
  (
    ...
    'citizen', 'CD27', 'Lubumbashi — Haut-Katanga', 2, 'pcode',
    ARRAY['CD27'], NULL, NOW() - INTERVAL '3 hours',
